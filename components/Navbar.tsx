      ...
      <div className="max-w-7xl mx-auto px-6 md:px-8 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-2">
          <div className="flex items-center bg-white/5 rounded-full px-6 py-2 border border-white/5 mr-6 backdrop-blur-sm">
             ...
             <button onClick={() => scrollToSection('testimonials')} className="px-5 py-1 text-base font-medium text-zinc-400 hover:text-primary transition-colors">Stories</button>
          </div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-8 text-center p-8 w-full max-w-sm">
              ...
              <button onClick={() => scrollToSection('testimonials')} className="text-2xl font-display font-medium text-zinc-300 hover:text-primary">Stories</button>
