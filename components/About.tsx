      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-display font-extrabold mb-8 md:mb-10 leading-tight" style={{ color: '#F5F7FA', letterSpacing: '-0.5px' }}>
              Driven by data.<br />
              <span style={{ color: 'rgba(255,255,255,0.35)' }}>Obsessed with growth.</span>
            </h2>

            <div className="space-y-6 md:space-y-8 text-lg md:text-xl mb-10 md:mb-12" style={{ color: 'rgba(255,255,255,0.65)', lineHeight: 1.6 }}>
              <p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              {['Data-Driven Strategies', 'Impeccable Development', 'Active CRO Efforts', 'SEO Optimization'].map((item, i) => (
                <div key={i} className="flex items-start gap-4" style={{ color: 'rgba(255,255,255,0.75)' }}>
                ...
                <div className="relative w-48 h-48 md:w-72 md:h-72">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <div className="text-4xl md:text-6xl font-display font-extrabold flex items-center justify-center" style={{ color: '#F5F7FA' }}>
                        <Counter value={98} />
